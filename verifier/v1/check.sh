...
chk "4 模板可载入编辑器" "grep -rq 'pattern' src/components/studio/ "
...
chk "6 Navbar 5 链接" "test \$(grep -c 'to=' src/lib/nav-links.ts 2>/dev/null || grep -c 'path' src/lib/nav-links.ts) -ge 5"
